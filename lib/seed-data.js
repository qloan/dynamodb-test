...
function RandomClient() {
	return {
		...
		personal_information: {
			first_name: 'John',
			last_name: 'Doe' + util.random(),
			street_address: util.random(1000,9999) + " Woodward Ave",
			city: 'Detroit',
			state: 'MI',
...
function RandomLoan(clientId) {
	return {
		...
		current_payperiod_balance: util.random(0, 100),
		current_payperiod_due: (new Date()).getTime() + util.random(0, 86400 * 30)
	};
}
